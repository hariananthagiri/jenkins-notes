...
5. environment
    ...
    * to see all environment variables use **env** command
...
```
* first time when we run prameters in jenkins it wont work we have use an option called **build with parameters** enable it
* **POST**
